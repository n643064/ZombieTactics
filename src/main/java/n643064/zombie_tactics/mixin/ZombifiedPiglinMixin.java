    ...
    protected void addBehaviourGoals()
    {
        if (Config.affectPiglins)
        {
            this.goalSelector.addGoal(1,
                    new ZombieAttackGoal(this, 1.0, true));

            this.goalSelector.addGoal(1, new ZombieAttackGoal(this,
                    1.0, true));
            ...
            if (Config.mineBlocks)
                this.goalSelector.addGoal(Config.miningPriority,
                        new ZombieMineGoal<>((Zombie & IMarkerFollower) this));

            if (Config.enableMarkers)
            {
                this.goalSelector.addGoal(2,
                        new RemoveMarkerGoal<>((Zombie & IMarkerFollower) this));

                this.goalSelector.addGoal(Config.markerPathingPriority,
                        new MoveTowardsMarkerGoal<>((Zombie & IMarkerFollower) this));
            }
        } else
            this.goalSelector.addGoal(2,
                    new ZombieAttackGoal(this, 1.0, false));
        ...
        this.targetSelector.addGoal(3,
                new ResetUniversalAngerTargetGoal<>(this, true));
    }
}
